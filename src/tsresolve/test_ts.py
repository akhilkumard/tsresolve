...
class TimestampRoutes_Point_of_time_Tests(unittest.TestCase):
    ...
    def test_point_of_time_01(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 1, 21, 0, 0).isoformat()
    ...
    def test_point_of_time_03(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 1, 8, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_05(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 2, 9, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
    ...
    def test_point_of_time_10(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 2, 17, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_14(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 3, 16, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_19(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 3, 10, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    # TODO This should prompt all time slots for the entire day, until the assistant don't have facility to ask for the timing.
    def test_point_of_time_21(self):
        result = point_of_time("Schedule a meeting with Krishna on monday", NOW)
        expected_timestamp = datetime.datetime(2018, 12, 3, 9, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], False)
    ...
    def test_point_of_time_29(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 5, 9, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], False)
    ...
    def test_point_of_time_33(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 5, 21, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_36(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 5, 23, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_42(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 8, 16, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)

    def test_point_of_time_43(self):
        result = point_of_time("Schedule a meeting with Priyanka on next week 4 a.m.", NOW)
        expected_timestamp = datetime.datetime(2018, 12, 8, 4, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_50(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 4, 6, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_62(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 4, 8, 15, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_71(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 6, 8, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_73(self):
        ...
        expected_timestamp = datetime.datetime(2019, 1, 7, 9, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], False)
    ...
    def test_point_of_time_75(self):
        ...
        expected_timestamp = datetime.datetime(2019, 1, 7, 18, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_76(self):
        ...
        expected_timestamp = datetime.datetime(2019, 2, 4, 9, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], False)
    ...
    def test_point_of_time_77(self):
        ...
        expected_timestamp = datetime.datetime(2019, 2, 4, 18, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_80(self):
        ...
        expected_timestamp = datetime.datetime(2019, 8, 5, 9, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], False)
    ...
    def test_point_of_time_84(self):
        ...
        expected_timestamp = datetime.datetime(2019, 8, 5, 5, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_91(self):
        ...
        expected_timestamp = datetime.datetime(2019, 8, 5, 17, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_93(self):
        ...
        expected_timestamp = datetime.datetime(2019, 11, 5, 9, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], False)
    ...
    def test_point_of_time_95(self):
        ...
        expected_timestamp = datetime.datetime(2019, 11, 5, 14, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)

    def test_point_of_time_96(self):
        result = point_of_time("Schedule a meeting on 5th of November at 2:30 p.m. with raja", NOW)
        expected_timestamp = datetime.datetime(2019, 11, 5, 14, 30, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_98(self):
        ...
        expected_timestamp = datetime.datetime(2019, 11, 8, 9, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], False)
    ...
    def test_point_of_time_10(self):
        ...
        expected_timestamp = datetime.datetime(2019, 11, 8, 14, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_103(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 4, 19, 30, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
    ...
    def test_point_of_time_113(self):
        ...
        expected_timestamp = datetime.datetime(2018, 12, 2, 20, 0, 0).isoformat()
        self.assertEqual(result[0], expected_timestamp)
        self.assertEqual(result[1], True)
...
class TimestampRoutes_Period_of_time_Tests(unittest.TestCase):
    ...
    def test_period_of_time_11(self):
        ...
        expected_timestamp = (datetime.datetime(2018, 1, 1, 0, 0, 0).isoformat(), datetime.datetime(2019, 12, 31, 23, 59, 59).isoformat())
        self.assertEqual(result, expected_timestamp)
    ...
    def test_period_of_time_17(self):
        ...
        expected_timestamp = (datetime.datetime(2018, 10, 1, 0, 0, 0).isoformat(), datetime.datetime(2018, 11, 30, 23, 59, 59).isoformat())
        self.assertEqual(result, expected_timestamp)
    ...
    def test_period_of_time_84(self):
        result = period_of_time("Search meetings from Monday morning to Thursday evening in first week of this August",NOW)
        expected_timestamp = ("","")
        self.assertEqual(result, expected_timestamp)

    @unittest.skipIf(True, 'Too ambitious')
    def test_period_of_time_85(self):
        result = period_of_time("Search meetings from Monday morning to Thursday evening in first week of last August",NOW)
        expected_timestamp = ("","")
        self.assertEqual(result, expected_timestamp)
